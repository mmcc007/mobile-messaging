// custom.ChatWidget
define(["dojo/_base/declare","dijit/_WidgetBase", "dijit/_TemplatedMixin", "dojo/text!./ChatWidget/templates/ChatWidget.html", "dojo/dom-style", "dojo/_base/fx", "dojo/_base/lang", "dojo/dom-attr", "dojo/cookie", "dojo/json", "dojox/cometd", "dojox/cometd/timestamp", "dojox/cometd/ack", "dojox/cometd/reload"],
    function(declare, WidgetBase, TemplatedMixin, template, domStyle, baseFx, lang, domAttr, cookie, json, cometd){
        return declare("custom.ChatWidget", [WidgetBase, TemplatedMixin], {
        	statics: {
