...
<body style="visibility:hidden;" >
		...
		<div id="contacts" data-dojo-type="bywaze.ContactsView" data-dojo-props="selected: true, provider: provider, code: code">
			...
			<ul id="test" data-dojo-type="dojox.mobile.EdgeToEdgeList" select="multiple">
				<li dojoType="dojox.mobile.ListItem">item 1</li>
				<li dojoType="dojox.mobile.ListItem">item 2</li>
				<li dojoType="dojox.mobile.ListItem">item 3</li>
				<li dojoType="dojox.mobile.ListItem">item 4</li>
