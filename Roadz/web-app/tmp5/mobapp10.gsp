...
//					var w = dijit.byId('friends');
//					w.performTransition('contacts',1,"fade",null);
//					domStyle.set("contacts", "display", "ddd")
...
<body style="visibility:hidden;" >
		...
		<div id="contacts" data-dojo-type="dojox.mobile.ScrollableView" data-dojo-props="selected: true">
			<h1 dojoType="dojox.mobile.Heading" fixed="top"
